  ...
  try {
    ...
    try {
      ...
      for (const [sym, pos] of Object.entries(balances)) {
        ...
        if (sym === 'USD' || pos.notional < 1.00) continue;
        
        const currentPrice = pos.notional / pos.amount;
        
        openPositionsDetailed[sym] = {
          amountHeld: pos.amount,
          currentPrice: currentPrice,
          currentValueUsd: pos.notional,
          // Since this is a live fetch, we don't have historical cost basis. 
          // We assume cost basis is roughly current notional to avoid massive fake P/L spikes.
          costBasisUsd: pos.notional,
          unrealizedPlUsd: 0 
        };
      }
