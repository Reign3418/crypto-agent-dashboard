...
export async function getDeepDiveAnalysis() {
  ...
  try {
    ...
    return {
      ...
      _systemNote: "Dust positions (< $1.00 USD) and manually closed historical trades are intentionally omitted from openPositions. Do not flag totalBuys > totalSells as an error if openPositions is empty.",
