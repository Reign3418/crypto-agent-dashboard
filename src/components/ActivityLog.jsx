...
export default function ActivityLog({ isHalted }) {
  ...
  return (
    <section className="glass-panel" style={{ display: 'flex', flexDirection: 'column', gap: '20px', minHeight: '300px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', maxHeight: '400px', overflowY: 'auto' }}>
        {loading ? (
            ...
            <div 
                ...
                gap: '16px', 
                padding: '12px 16px', 
                background: log.highlight ? 'rgba(74, 158, 255, 0.1)' : 'var(--bg-tertiary)', 
                borderLeft: log.highlight ? '3px solid var(--accent-blue)' : '3px solid var(--border-subtle)',
                borderRadius: '0 8px 8px 0',
                fontSize: '0.95rem'
                }}
            >
                <div className="text-muted" style={{ minWidth: '70px', fontSize: '0.85rem', paddingTop: '2px' }}>
                {log.time}
                </div>
